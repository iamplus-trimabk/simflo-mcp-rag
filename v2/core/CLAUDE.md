...
core/00-rag-registry/registry.py list --format json
core/00-rag-registry/registry.py info --name shadcn --format json
core/00-rag-registry/registry.py search --query "button" --limit 10 --format json
core/00-rag-registry/registry.py status --format json
core/01-mcp-server/mcp_server.py search "button" --limit 10 --format json
core/01-mcp-server/mcp_server.py get-component dialog --registry shadcn --format json
core/01-mcp-server/mcp_server.py list-registries --format json
core/01-mcp-server/mcp_server.py set-context reactjs --format json
```
...
python3 core/00-rag-registry/registry.py info --name shadcn --format json
...
python3 v2/core/00-rag-registry/tests/run.py

# Run with verbose output
python3 v2/core/00-rag-registry/tests/run.py --verbose

# Generate test report
python3 v2/core/00-rag-registry/tests/run.py --output test_report.json
...
python3 v2/core/01-mcp-server/mcp_server.py search "modal dialog" --limit 5 --format json
